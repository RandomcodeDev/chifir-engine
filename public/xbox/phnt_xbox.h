...
#define DESKTOP_ALL_ACCESS                                                                                                       \
	(DESKTOP_CREATEMENU | DESKTOP_CREATEWINDOW | DESKTOP_ENUMERATE | DESKTOP_HOOKCONTROL | DESKTOP_JOURNALPLAYBACK |             \
	 DESKTOP_JOURNALRECORD | DESKTOP_READOBJECTS | DESKTOP_NXDESKTOP | DESKTOP_WRITEOBJECTS | STANDARD_RIGHTS_REQUIRED)
...
#define DESKTOP_GENERIC_EXECUTE (DESKTOP_NXDESKTOP | STANDARD_RIGHTS_EXECUTE)
