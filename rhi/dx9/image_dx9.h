...
class CDx9RhiImage: public IRhiImage, public CDxRhiBaseObject<IDirect3DTexture9>
{
  public:
...
class CDx9RhiRenderTarget: public IRhiRenderTarget, public CDxRhiBaseObject<IDirect3DSurface9>
{
  public:
